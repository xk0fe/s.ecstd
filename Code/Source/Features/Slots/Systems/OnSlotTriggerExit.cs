...
public class OnSlotTriggerExit : SystemBase
{
	private EntityFilter _filter = new EntityFilter( World.Default )
		.With<SlotComponent>().With<OnTriggerExitComponent>();
	...
	public override void Update( float deltaTime )
	{
		...
		{
			ref var component = ref entity.GetComponent<OnTriggerExitComponent>();
